    ...
    return (
        <>
            <header className='intro-container'>
                ...
                <p>Get ready for interviews with our conversational AI voice bot. Practice and improve your skills anytime, anywhere.</p>
                <div className="buttons">
                    <button onClick={goToSignup}className="btn btn-signup">Sign Up Now</button>
                    <button onClick={goToLogin} className='btn btn-login'>Login Now</button>
                    <button onClick={goToAbout} className="btn btn-learn-more">Learn More</button>
                </div>
            </header>
