            ...
            <div className="transcript-modal-container">
                ...
                <div className="average-container">
                    ...
                    <div className="average-star-container">
                        <div
                            style={{
                                backgroundColor: colors[scoreAverages[0]],
                            }}
                        ...
                        <div
                            style={{
                                backgroundColor: colors[scoreAverages[1]],
                            }}
                            className="star-average"
                        >
                            <h3>Task</h3>
                        ...
                        <div
                            style={{
                                backgroundColor: colors[scoreAverages[2]],
                            }}
                            className="star-average"
                        >
                            <h3>Action</h3>
                        ...
                        <div
                            style={{
                                backgroundColor: colors[scoreAverages[3]],
                            }}
                            className="star-average"
                        >
                            <h3>Result</h3>
                    ...
                    <div className="color-scale">
                        ...
                        <div className="color-chart">
                            ...
                            <div
                                className="color-value"
                                style={{ backgroundColor: colors["best"] }}
                            ></div>
                        </div>
                    </div>
                </div>
                ...
                <div className="freq-main">
                    ...
                    <div className="freq-container">
                        ...
                        {freqPhrases.length > 0 ? (
                            freqPhrases.map((word, index) => {
                                return (
                                    <h3 className="freq-word">
                                        {word[0]}: {word[1]}
                                    </h3>
                                );
                            })
                ...
                <div>
                    {messagesPass.length > 0 ? (
                        messagesPass?.map((message, index) => {
                            return (
                                <div className="messages-container" key={index}>
                                    ...
                                    <div className="messages-transcript">
                                        <pre className="messages-transcript-inner">
