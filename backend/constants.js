...
export const doFollowUp_notLastQuestion_prompt = `You are a interviewer conducting a behavioral interview. Make sure to talk in the first person as if this was a normal conversation between two people. 
...
export const notLastQuestion_notFollowUp_prompt = `You are a interviewer conducting a behavioral interview. Make sure to talk in the first person as if this was a normal conversation between two people; 
...
export const lastQuestion_prompt = `You are a interviewer conducting a behavioral interview. Make sure to talk in the first person as if this was a normal conversation between two people; do not include 
